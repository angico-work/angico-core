...
public class OntologyService {
    ...
    private static final List<RelationRule> DEFAULT_RELATION_RULES = List.of(
            ...
            new RelationRule(CONVERSA, "REFERE_SE_A", OBSERVACAO),
            new RelationRule(CONVERSA, "REFERE_SE_A", PROBLEMA),
            new RelationRule(CONVERSA, "REFERE_SE_A", POTENCIALIDADE),
            new RelationRule(CONVERSA, "REFERE_SE_A", MISSAO),
            new RelationRule(CONVERSA, "REFERE_SE_A", ACAO),
            new RelationRule(CONVERSA, "REFERE_SE_A", RESULTADO),
            new RelationRule(CONVERSA, "REFERE_SE_A", INDICADOR),
